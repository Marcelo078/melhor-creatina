  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        cta: "bg-cta-gradient text-secondary-foreground shadow-cta hover:scale-105 hover:shadow-hover",
        hero: "bg-primary text-primary-foreground border-2 border-primary-foreground/20 hover:bg-primary/80 hover:scale-105 shadow-lg",
        accent: "bg-accent-gradient text-accent-foreground hover:scale-105 shadow-lg",
        buy: "bg-secondary text-secondary-foreground hover:scale-105 shadow-cta font-bold uppercase tracking-wide",
      },
      size: {
